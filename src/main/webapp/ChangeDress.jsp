        ...
        <div id="container">
            ...
            <div id="border">
                <div id="main">
                    ...
                    <div id="right">
                        <div class="content">
                            <h2>Редактирование данных о костюме</h2>
                            <form method="POST">
                                <div align="center">Номер костюма<br>
                                    <input type="text" id="id_dress" name="id_dress" class="inptext">
                                </div>
                                <div align="right">
                                    <dd>&nbsp;</dd>
                                    <input type="submit" id="searchById_dress" name="command" value="Редактировать" class="knopka">
                                </div>
                            </form>                       
                        </div>
                    </div>
