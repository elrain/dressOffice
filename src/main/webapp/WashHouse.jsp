                    ...
                    <div id="right">
                        <div class="content">
                            ...
                            <form method="POST" name="poi">
                                ...
                                <div align="right">
                                    <dd>&nbsp;</dd>
                                    <input type="submit" id="goToWashHouse" name="command" value="Отправить в прачечную"  class="knopka"><br>
                                    <input type="submit" id="fromWashHouse" name="command" value="Принять с прачечной"  class="knopka">
                                </div>
                            </form>
                        </div>
                    </div>
